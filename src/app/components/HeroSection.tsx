    ...
    <div>
      ...
      <div className="h-screen w-full rounded-md flex-col items-center justify-center relative overflow-auto mx-auto py-10 md:py-0">
        <div className="p-4 relative z-10 w-full text-center mt-10 md:mt-20">
          <h1 className="text-4xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent animate-fade-in-up flex items-center justify-center gap-2">
            <ContainerTextFlip />
